...
def get_assistant(llm_model: str, embeddings_model: str) -> Assistant:
    """Retourne une instance de l'assistant avec les modèles spécifiés et une instruction pour répondre en français."""
    ...
    # Ajouter une instruction explicite pour répondre en français
    assistant.set_system_message("Veuillez répondre uniquement en français.")
    return assistant
